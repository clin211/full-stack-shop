...
type AddGoodsReq struct {
	...
	//ProductionAt string `json:"production_at"` // v"#生产日期必传"
	//ShelfLife    string `json:"shelf_life"`    //v:"#保质期必传"
}
...
type UpdateGoodsReq struct {
	...
	Stock       int    `json:"stock" v:"required#库存必传"`
	Tags        string `json:"tags" v:"required#标签必传"`
	DetailInfo  string `json:"detail_info" v:"#详情必传"`
	//ProductionAt string `json:"production_at"` // v:"#生产日期必传"
	//ShelfLife    string `json:"shelf_life"`    // v:"required#保质期必传"
}
...
type ListGoodsSql struct {
	...
	//ProductionAt string `json:"production_at"`
